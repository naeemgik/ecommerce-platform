...
public class ProductEventConsumer {
	...
	@KafkaListener(topics = PRODUCT_CACHE_INVALIDATION_TOPIC, groupId = "${spring.kafka.consumer.group-id:product-service-group}", containerFactory = "kafkaListenerContainerFactory")
	...
	@KafkaListener(topics = PRODUCT_VIEWED_TOPIC, groupId = "${spring.kafka.consumer.group-id:product-service-group}-analytics", containerFactory = "kafkaListenerContainerFactory")
